...
class AddInfo extends Component {
  ...
  handleSubmit() {
    const description = findDOMNode(this.refs.linkOne).value;
    const city = findDOMNode(this.refs.linkTwo).value;
    const country = findDOMNode(this.refs.linkThree).value;
